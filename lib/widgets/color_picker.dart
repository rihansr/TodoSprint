...
class ColorController extends ValueNotifier<HSVColor> {
...
class ColorPicker extends StatefulWidget {
  ...
  /// Controller to control (get/set) the value of the [ColorPicker] from outside
  /// of the widget.
...
class _ColorPickerState extends State<ColorPicker> {
  ...
  void initState() {
    ...
    _controller = widget.controller ?? ColorController(widget.initialColor!);
